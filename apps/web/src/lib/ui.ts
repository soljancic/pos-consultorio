...
export const inputUI =
  'w-full h-11 rounded-lg border border-input bg-card px-3 text-base sm:text-sm text-foreground placeholder:text-muted-foreground/55 hover:border-muted-foreground/30 focus:outline-none focus-visible:ring-[3px] focus-visible:border-ring focus-visible:ring-ring/45 transition-colors duration-150'

export const textareaUI =
  'w-full rounded-lg border border-input bg-card px-3 py-2 text-base sm:text-sm text-foreground placeholder:text-muted-foreground/55 hover:border-muted-foreground/30 focus:outline-none focus-visible:ring-[3px] focus-visible:border-ring focus-visible:ring-ring/45 transition-colors duration-150 resize-none'
...
export const btnOutlineUI =
  'inline-flex items-center justify-center gap-1.5 h-11 px-4 border border-input bg-card text-foreground rounded-lg text-sm font-medium cursor-pointer hover:bg-muted/60 focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/60 disabled:opacity-60 disabled:cursor-not-allowed transition-colors duration-150'
