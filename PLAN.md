...
- **Mejoras pedidas por el owner (2026-06-11)**: (a) ✔ cero `window.confirm/alert` — ConfirmarModal compartido, regla en CLAUDE.md; (b) ⬜ pase de acentos en todo el copy del frontend; (c) ✔ usuario DOCTOR asociado a su Doctor con edicion de su propio Calendario de Atencion (HECHO 2026-06-11, gate-usuario-doctor 9/9)
